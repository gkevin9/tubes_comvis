...
def open():
    ...
    my_image = ImageTk.PhotoImage(Image.open(root.filename).resize((200,200), Image.ANTIALIAS))
...
label_1 = Label(root, text="Logo Recognition",width=20,font=("bold",20))
label_1.place(x=90, y=450)
